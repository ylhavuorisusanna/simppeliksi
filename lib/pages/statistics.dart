...
class _StatisticsPageState extends State<StatisticsPage> {
  ...
  void _loadTarget() async {
    ...
    setState(() {
      targetAmount = prefs.getInt('targetAmount') ?? 0;
            ...
            Row(
              ...
              children: [
                LinearPercentIndicator(
                  ...
                  percent:
                      (targetAmount > 0)
                          ? (_items.length / targetAmount).clamp(0.0, 1.0)
                          : 0.0,
                ...
                child:
                    dataMap.isNotEmpty
                        ? PieChart(
                          ...
                          emptyColorGradient: [Color(0xff6c5ce7), Colors.blue],
                        )
                        : SizedBox(
                    ...
                    child: ClipRRect(
                      ...
                      child: Container(
                        ...
                        child: DataTable(
                          ...
                          rows:
                              monthlyCounts.entries.map((entry) {
                                return DataRow(
                                  cells: [
                                    DataCell(
                                      Text(
